<div class="mainleftinner">
    <div class="leftmenu">
        <ul>
            ...
            <li><a href="<?php echo base_url(); ?>admin/category" class="widgets menudrop"><span>Danh mục khung ảnh</span></a>
                <ul>                
                    <li><a href="<?php echo base_url(); ?>admin/category"><span>Tất cả danh mục</span></a></li>     
